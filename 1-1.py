...
class PizzaStore(DeliveryStore):
    ...
    # [<__main__.Food object at 0x0000020F03195700>, <__main__.Food object at 0x0000020F031957C0>~]
            for menu in self.menu_list:
                print(menu.name) # cheese, potato, shrimp, pineapple, meatball
                print(menu.price) # 11100, 12600, 13300, 21000, 19500
                if order == menu.name:
